...
create or replace storage integration s3_int
  ...
  storage_provider = s3
  enabled = true
  storage_aws_role_arn = 'arn:aws:iam::533267010791:role/AWS2Snowflake'
  storage_allowed_locations = ('s3://de-weather-project/snowflake/');
...
create or replace stage ext_csv_stage
  URL = 's3://de-weather-project/snowflake/'
